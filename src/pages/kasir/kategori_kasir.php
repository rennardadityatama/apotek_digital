                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="kategori_kasir.php?delete_id=<?= $row['id']; ?>"
    ...
    <div class="modal fade" id="kategoriModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="kategori_kasir.php" method="POST">
                    ...
                    <div class="modal-body text-center">
                        <div class="mb-3">
                            ...
                            <input type="text" name="category" class="form-control" id="namaKategori" placeholder="Masukkan nama kategori" required>
                        </div>
                    </div>
