        ...
        <div class="w-1/2 bg-white flex flex-col justify-center px-10">
            ...
            <form action="../service/auth.php" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="Enter your Password"
                            class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500" />
                ...
                <div class="text-right">
                    <a href="./forgot.php" class="text-sm text-yellow-500 hover:underline">Forgot Password?</a>
                </div>
            </form>
        </div>
